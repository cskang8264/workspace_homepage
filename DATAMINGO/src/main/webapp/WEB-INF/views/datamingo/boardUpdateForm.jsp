...
<body>
	...
	<div class="container">
		...
		<br> <br>
		<c:forEach var="sbi" items="${SelectedBoardbyId}" varStatus="status">
			<form action="/noticeupdate/${sbi.board_id}"  method="post">
				<div class="form-group">
					<i class="fa fa-edit" style="font-size: 25px; color: red"> </i> <label
						for="exampleFormControlInput1">제목</label> <input type="text"
						class="form-control" id="title" value="${sbi.title} " name="title">
				</div>

				<div class="form-group">
					<i class="fa fa-align-left" style="font-size: 25px; color: red">
					</i> <label for="exampleFormControlInput1">본문</label>
					<textarea class="form-control" id="text" rows="10" name="text"> ${sbi.text}</textarea>
				</div>
				<div style="text-align: center;">
